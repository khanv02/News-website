...
│   │   ├── homeGTDS.html              # Hub chuyên mục
│   │   └── giai-tri-doi-song-detail.html
│   │
...
```html
local-fonts.css   → @font-face
bootstrap.min.css → reset + utilities
root.css          → design tokens (:root variables)
navbar.css        → component
section1–4.css    → page-level sections
horizontal-feed.css
```
...
|---|---|---|
| `html/Index.html` | Trang chủ (4 sections) | navbar.js, sectionTwo.js, sectionThree.js, horizontalFeed.js, auth.js |
...
| `html/giai-tri-doi-song/homeGTDS.html` | Hub Giải trí & Đời sống | navbar.js, auth.js |
| `html/giai-tri-doi-song/*-detail.html` | Chi tiết bài viết GTDS | navbar.js, auth.js |
| `html/vu-tru-thien-nhien/*-detail.html` | Chi tiết bài viết VTTN | navbar.js, auth.js |
...
```css
/* ── Colors ──────────────── */
--nw-text:        #1c1c1a   /* body text */
--nw-bg:          #ffffff
--nw-accent:      #ffdd00   /* yellow highlight */
--nw-accent-red:  #c30000   /* NEW badge, danger */

/* ── Typography ──────────── */
--nw-font-sans:     "Inter", sans-serif
--nw-font-heading:  "Oswald", sans-serif
--nw-font-display:  "Playfair Display", serif
--nw-font-serif:    "Merriweather", serif
--nw-font-script:   "Dancing Script", cursive
--nw-font-mono:     "Space Mono", monospace
--nw-font-news:     "Newsreader", sans-serif

/* ── Radius ───────────────── */
--nw-radius-sm: 4px  │ -md: 8px  │ -lg: 12px  │ -xl: 16px  │ -pill: 999px

/* ── Shadows ─────────────── */
--nw-shadow-sm/-md/-lg/-xl

/* ── Transitions ─────────── */
--nw-transition-fast: 0.2s ease
--nw-transition-base: 0.3s ease
